...
``` bash
curl -s https://raw.githubusercontent.com/mberjawi/odoo14-docker/master/run.sh | sudo bash -s odoo-one 10014 20014
```

to set up first Odoo instance @ `localhost:10014` (default master password: `marwanberjawi.com`)

and

``` bash
curl -s https://raw.githubusercontent.com/mberjawi/odoo14-docker/master/run.sh | sudo bash -s odoo-two 11014 21014
```

to set up another Odoo instance @ `localhost:11014` (default master password: `marwanberjawi.com`)
...
``` sh
$ git clone https://github.com/mberjawi/odoo14-docker
